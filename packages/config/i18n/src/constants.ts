...
export const DataTableMessages = ye.StructFromReadonlyArray(
  DATA_TABLE_MESSAGES,
  ye.NonEmptyStr,
);
...
export const SupportedLocales = S.Literal("en");
export type SupportedLocales = typeof SupportedLocales.Type;

export const LocaleNumberFormatUnion = S.Union(
  S.Struct({
    code: S.Literal(LOCALE_CODES.en),
    currency: S.Literal(CURRENCIES.USD),
  }),

...
export type MapProps = ReactMapProps & { sx?: SxProps<Theme>, mapboxApiKey: string, projection: Projection };
    ...
    <MapRoot sx={sx}>
      {isClient ? (
        <Suspense fallback={renderFallback()}>
          <LazyMap ref={ref} mapboxAccessToken={props.mapboxApiKey} {...other} />
        </Suspense>
      ) : (
        renderFallback()
      )}

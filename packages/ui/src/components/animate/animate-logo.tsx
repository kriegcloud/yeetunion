...
export type AnimateLogoProps = ComponentProps<"div"> & {
  sx?: SxProps<Theme>;
  logo?: ReactNode;
  slotProps?: {
    logo?: LogoProps;
...
export const AnimateLogoZoom = forwardRef<HTMLDivElement, AnimateLogoProps>(
  (props, ref) => {
...
export const AnimateLogoRotate = forwardRef<HTMLDivElement, AnimateLogoProps>(
  (props, ref) => {

 ...
 * @since 0.1.0
 */
export declare const StrWithDefault: (value: string) => S.PropertySignature<":", string, never, ":", string, true, never>;
/**
 * @category primitives
 * @since 0.1.0
 */
declare const _default: {
    ...
    StrWithDefault: (value: string) => S.PropertySignature<":", string, never, ":", string, true, never>;
};

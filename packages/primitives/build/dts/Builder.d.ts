...
declare const BuilderError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }) => import("effect/Cause").YieldableError & {
...
export interface BuilderOp<F extends Schema.Struct.Fields, R> {
    ...
    readonly when: (predicate: (a: Partial<SchemaType<F>>) => boolean, ifTrue: Transform<SchemaType<F>>, ifFalse?: Transform<SchemaType<F>>) => Transform<SchemaType<F>>;
 ...
 * @category models
 */
export type Builder<F extends Schema.Struct.Fields, R> = BuilderOp<F, R> & Omit<BuilderLens<SchemaType<F>>, keyof BuilderOp<F, R>>;
/**
 ...
 * // {
 */
export declare const define: <F extends Schema.Struct.Fields>(schema: Schema.Struct<F>, defaults?: Partial<SchemaType<F>>) => Builder<F, Schema.Schema.Context<F[keyof F]>>;
/**
 * @since 0.1.0

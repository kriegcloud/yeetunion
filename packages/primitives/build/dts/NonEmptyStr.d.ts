 ...
 * @since 0.1.0
 */
export declare const NonEmptyStrWithDefault: (value: string) => S.PropertySignature<":", string, never, ":", string, true, never>;
/**
 * @category primitives
 * @since 0.1.0
 */
 ...
 * @since 0.1.0
 */
export declare const NonEmptyTrimStrWithDefault: (value: string) => S.PropertySignature<":", string, never, ":", string, true, never>;
/**
 * @category primitives
 * @since 0.1.0
 */
declare const _default: {
    ...
    NonEmptyStrWithDefault: (value: string) => S.PropertySignature<":", string, never, ":", string, true, never>;
    ...
    NonEmptyTrimStrWithDefault: (value: string) => S.PropertySignature<":", string, never, ":", string, true, never>;
};

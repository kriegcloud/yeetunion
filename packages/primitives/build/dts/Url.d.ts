 ...
 * @since 0.1.0
 */
export declare const URLOrNull: S.NullOr<
 ...
 * @since 0.1.0
 */
export declare const URLOrUndefined: S.UndefinedOr<
  S.filter<S.Schema<string, string, never>>
>;
/**
 * @category primitives
 ...
 * @since 0.1.0
 */
export declare const URLOrNullish: S.NullishOr<
  S.filter<S.Schema<string, string, never>>
>;
/**
 * @category primitives
 ...
 * @since 0.1.0
 */
export declare const URLOptional: S.optional<
  S.filter<S.Schema<string, string, never>>
>;
/**
 * @category primitives
